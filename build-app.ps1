...
# build-openconnect.ps1 + build-vpnc.ps1 and copied into the output by the
# CopyBackend target. For the self-contained single-file release, use publish-app.ps1.
param([switch]$Debug)
